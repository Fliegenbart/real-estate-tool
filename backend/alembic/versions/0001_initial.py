...
def upgrade() -> None:
    ...
    op.create_table("location_scores", sa.Column("id", sa.Integer(), primary_key=True), sa.Column("deal_id", sa.Integer(), sa.ForeignKey("deals.id"), nullable=False), sa.Column("population_trend_score", sa.Integer(), nullable=False), sa.Column("vacancy_risk_score", sa.Integer(), nullable=False), sa.Column("purchasing_power_score", sa.Integer(), nullable=False), sa.Column("public_transport_score", sa.Integer(), nullable=False), sa.Column("employer_access_score", sa.Integer(), nullable=False), sa.Column("micro_location_score", sa.Integer(), nullable=False), sa.Column("transit_access_score", sa.Integer(), nullable=False), sa.Column("daily_needs_score", sa.Integer(), nullable=False), sa.Column("demand_anchor_score", sa.Integer(), nullable=False), sa.Column("leisure_quality_score", sa.Integer(), nullable=False), sa.Column("short_term_rental_score", sa.Integer(), nullable=False), sa.Column("nuisance_resilience_score", sa.Integer(), nullable=False), sa.Column("noise_risk_score", sa.Integer(), nullable=False), sa.Column("flood_risk_score", sa.Integer(), nullable=False), sa.Column("source", sa.String(length=80), nullable=False), sa.Column("evidence_inputs", sa.JSON(), nullable=True))
